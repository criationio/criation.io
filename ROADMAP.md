...
**Próxima sessão:** 1.4.9.B — Google EC fanout via **Data Manager API** + OAuth Google antecipado. Cadeia restante: **1.4.9.B** (Google via Data Manager API) → **1.4.9.C** (cleanup `click_id_store` legacy) → **1.4.9.5** (shadow validation E2E em prod real, gate antes de 1.6). 1.4.9 (Meta CAPI) fechada 2026-05-12. **Spike 1.4.9.B passo 1 concluído 2026-05-13** — decisão Data Manager API (não `ConversionUploadService`) documentada em [ADR-015](./docs/adr/ADR-015-plataforma-google-2026.md).
