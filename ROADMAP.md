...
**Próxima sessão:** 1.4.8 — UTM Stitcher service (1.4.5/1.4.6/1.4.7 fechadas; refactor `connections` meta-tabela + hub UI entregue como sub-1.4 — [ADR-019](./docs/adr/ADR-019-meta-tabela-connections.md))
...
| Fase 1 — Core Value      | 🟡 Em andamento | 2026-05-07 | —          | 1.1-1.4.7 fechadas + sub-1.4 (ADR-019); 1.4.8 próxima |
