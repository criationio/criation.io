...
**Próxima sessão:** 1.4.9 — Meta CAPI fanout (Meta-only). Cadeia de tracking: **1.4.9** (Meta) → **1.4.9.B** (Google EC + OAuth Google antecipado) → **1.4.9.C** (cleanup `click_id_store` legacy) → **1.4.9.5** (shadow validation E2E em prod real, gate antes de 1.6).
...
| Fase 1 — Core Value      | 🟡 Em andamento | 2026-05-07 | —          | 1.1-1.4.8 + sub-1.4 + 1.4.A + 1.4.B fechadas; 1.4.9 (Meta) → 1.4.9.B (Google) → 1.4.9.C (cleanup) → 1.4.9.5 (shadow E2E) gate antes de 1.6 |
