...
**Próxima sessão:** **1.4.9.5** — Shadow validation E2E em prod real (gate antes de 1.6). 1.4.9.B (Google Data Manager API) fechada 2026-05-15 com audit pós-entrega. 1.4.9.C (drop `click_id_store`) fechada mesmo dia. Próximos bloqueios externos: OAuth verification Google submission (timeline 2-6 semanas), Developer Token Basic access (1-2 dias úteis), domínio `criation.io` verificado em Search Console, cliente alpha conectando Meta + Google Ads em prod.
...
| Fase 1 — Core Value      | 🟡 Em andamento | 2026-05-07 | —          | 1.1-1.4.8 + sub-1.4 + 1.4.A + 1.4.B + 1.4.9 (Meta CAPI) + 1.4.9.B (Google EC) + 1.4.9.C (cleanup) fechadas; 1.4.9.5 (shadow E2E) gate antes de 1.6 |
