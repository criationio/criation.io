...
**Próxima sessão:** 1.4.9 — CAPI fanout sender (Meta + Google EC) (1.4.A + 1.4.B fechadas)
...
**Bloqueios pré-cliente real (NOVOS):** [GATE pré-prod 1.4.8](./docs/checklists/PRE-PROD-VALIDATION-1.4.8.md) (UTM Stitcher) **+** TD-104 LGPD erasure path — endereçar antes do primeiro titular request real (audit 1.4.B reclassificou como bloqueio explícito).

| Fase                     | Status          | Início     | Fim        | Notas                                                                               |
| ------------------------ | --------------- | ---------- | ---------- | ----------------------------------------------------------------------------------- |
| Fase 0 — Pré-dev         | ✅ Concluído    | 2026-04    | 2026-05-07 | 4 sessões + correção pós-0.5                                                        |
| Fase 1 — Core Value      | 🟡 Em andamento | 2026-05-07 | —          | 1.1-1.4.8 fechadas + sub-1.4 (ADR-019) + 1.4.A (CDP) + 1.4.B (matching); 1.4.9 próx |
