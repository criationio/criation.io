...
NEVER use generic AI-generated aesthetics: overused fonts (Inter, Roboto, Arial), cliched color schemes (particularly purple gradients on white backgrounds), predictable layouts, cookie-cutter design.

**IMPORTANT**: Match implementation complexity to the aesthetic vision. Minimalist designs need restraint, precision, careful spacing and typography. Elegance comes from executing the vision well.
